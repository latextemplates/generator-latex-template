...
% In case you have an older texlive distribution, replace "pbalance" by "balance"
\documentclass[sigconf,review,pbalance]{acmart}
<% break; case "ieee": -%>
...
<% if (documentclass == 'acmart' || documentclass == 'ieee' || documentclass == 'lncs') { -%>
