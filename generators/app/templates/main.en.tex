...
\usepackage{iftex}
<% if ((documentclass != "acmart") && (documentclass != "ieee")) { -%>\usepackage{ifplatform}
<% } -%>
...
<% if (feature.abbreviations) { %><%- include('math.preamble.en.tex', this); -%>
...
\ifluatex
<% } -%>
<%= indent %>% Enable correct rendering of ligatures - provided by https://ctan.org/pkg/selnolig
<%= indent %>% See ADR-0009 for alternatives
