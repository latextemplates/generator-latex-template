...
\documentclass[<%= ieee_variant %>,<%= papersize %>paper,ngerman]{IEEEtran}[2015/08/26]
<% if (texlive >= 2021) { -%>
...
In diesem Abschnitt/Kapitel steht die Einleitung zu dieser Ausarbeitung.
...
<% } -%>
Schließlich fasst \cref{sec:outloo} die Ergebnisse der Arbeit zusammen und stellt Anknüpfungspunkte vor.
