...
Das Buch <%- bquote %>Student Thesis Projects<%- equote %>~\cite{Lichter2026} (Open Access) erklärt ausführlich, wie man eine Abschlussarbeit organisiert, durchführt, schreibt und präsentiert.
...
<% } -%>
<%- include('todos.example.de.tex', this); %>
...
<% indent = ''; switch (documentclass) { case "lncs": -%>
