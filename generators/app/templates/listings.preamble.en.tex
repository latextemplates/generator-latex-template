...
\ifpdftex
<% } -%>
<%= indent %>% Enable Umlauts when using \lstinputputlisting.
<%= indent %>% See https://stackoverflow.com/a/29260603/873282 and https://tex.stackexchange.com/a/24532/9075 for details.
<%= indent %>% listingsutf8 did not work in June 2020.
<%= indent %>\lstset{extendedchars=true, literate=
